  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className={`flex justify-between items-center transition-all duration-500 ${isScrolled ? 'h-14 md:h-20' : 'h-16 md:h-32'
            }`}>
            <Link href="/" className="flex items-center space-x-3 group outline-none">
              <Image
                ...
                height={96}
                priority
                className={`w-auto transition-all duration-500 group-hover:scale-105 ${isScrolled ? 'h-10 md:h-16' : 'h-12 md:h-28'
                  }`}
              />
            </Link>
